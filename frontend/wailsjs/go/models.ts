...
export namespace store {
	...
	export class AggregationScheduleEntry {
	    hour: number;
	    member: AggregationMember;
	
	    static createFrom(source: any = {}) {
	        return new AggregationScheduleEntry(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.hour = source["hour"];
	        this.member = this.convertValues(source["member"], AggregationMember);
	    }
	...
	export class AggregationStrategy {
	    ...
	    schedule?: AggregationScheduleEntry[];
	
	    static createFrom(source: any = {}) {
	        return new AggregationStrategy(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.attemptTimeoutSeconds = source["attemptTimeoutSeconds"];
	        this.schedule = this.convertValues(source["schedule"], AggregationScheduleEntry);
	    }
	...
	export class AggregationMember {
	    providerId: string;
	    modelId: string;
	
	    static createFrom(source: any = {}) {
	        return new AggregationMember(source);
	    }
	...
	export class AggregationConfig {
	    ...
	    static createFrom(source: any = {}) {
	        return new AggregationConfig(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.members = this.convertValues(source["members"], AggregationMember);
	        this.strategy = this.convertValues(source["strategy"], AggregationStrategy);
	    }
	...
	export class CallLog {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.aggregationSource = source["aggregationSource"];
	        this.aggAttempts = source["aggAttempts"];
	    }
	}
	...
	export class Model {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.createdAt = source["createdAt"];
	        this.updatedAt = source["updatedAt"];
	        this.aggregation = this.convertValues(source["aggregation"], AggregationConfig);
	    }
